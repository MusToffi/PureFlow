...
import 'water_data_widget.dart';


//root page: under 'where are you going?/ At "Live anywhere -> Cabins and Cottages'
const cabinImageUrl = 'https://bernardbc.com/wp-content/uploads/2023/04/SDG-6-water-and-sanitation.png';
...
//root page: At "Explore Nearby -> Sg. Pahang"
const cityImageUrl =
...
//root page: At "Explore Nearby -> Sg. Kuantan"
...
//root page: At "Explore Nearby -> Sg. Tahan"
            ...
            [
              Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 32),
                  SectionTitle(text: 'Nearby water'),
                  SizedBox(height: 24),
                  ExploreCityGrid(),
                  SizedBox(height: 48),
                  
                  SectionTitle(
                    text: 'Tentatived Events',
                  ),
                  SizedBox(height: 24),
                  LiveAnywhereComponent(),
                  SizedBox(height: 32),
                  SectionTitle(
                    text: 'Facts and Tricks ',
                    subtitle:
                        'Step-to-step guides to water managemant & treatment',
                  ),
                  SizedBox(height: 24),
  ...
  Widget build(BuildContext context) {
    const liveAnywhereWidgets = [
      LargeTitledImageWidget(
        text: 'National Water Treatment Visits',
        imageUrl: modernHouseImageUrl,
      ),
      LargeTitledImageWidget(
        text: 'Janda Baik Retreat',
        imageUrl: uniqueLakeCabinImageUrl,
      ),
      LargeTitledImageWidget(
        text: 'Run for Water 2.0',
        imageUrl: cabinImageUrl,
      ),
      LargeTitledImageWidget(
        text: 'Water talk:Series 2',
              ...
              child: Stack(
                ...
                children: [
                   Container(
                    ...
                    width: double.infinity,
                    color: const Color.fromARGB(255, 0, 0, 0), // Set this to your desired color
                  ),
                  Image.network(
                    cabinImageUrl,
                    fit: BoxFit.cover,
...
/// E.g. A list for saved trips for Pahang and a separate list for saved trips to California
class PlaceList {
  final String title;
...
const Place austinPlace1 = Place(
    title: 'Apartment home deep in the heart of Sg. Kuantan',
...
const PlaceList austinList =
    PlaceList(title: 'Sg. Kuantan', savedPlaces: [austinPlace1, austinPlace2]);

const PlaceList aspenList =
    PlaceList(title: 'Chenor, Pahang', savedPlaces: [aspen]);
